...
local b = _:New({Name = "                   bad lim script for lockers and noobs", FolderToSave = "smh"})
local _ = b:Tab("Info")
local a = _:Section("Click for message")
local _ = b:Tab("Valkyrie")
local h = _:Section("Valkyrie")
local _ = b:Tab("Horns")
local c = _:Section("Horns")
local _ = b:Tab("Dominus")
local i = _:Section("Dominus")
local _ = b:Tab("Fedora")
local j = _:Section("Fedora")
local _ = b:Tab("Crowns")
local n = _:Section("Crowns")
local _ = b:Tab("Clockwork/Headphones")
local x = _:Section("Clockwork/Headphones")
local _ = b:Tab("Sword")
local z = _:Section("Sword")
local _ = b:Tab("Federation Stuff")
local m = _:Section("Federation Stuff")
local _ = b:Tab("Faces")
...
a:Button(
    ...
    function()
        ...
        _:SetCore("SendNotification", {Title = "Discord", Text = "ilovebee#6666", Duration = 15})
    end
)
a:Button(
    "Dm if issues" ,
    ...
    z:Button(
    "Infernal Undead Immortal Sword",
    function()
        function l(a, _)
            local b = Instance.new("Weld")
            b.Part0 = a.Parent
